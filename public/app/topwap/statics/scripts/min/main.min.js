...
!function(e,i){e.dom=function(t){return"string"!=typeof t?t instanceof Array||t[0]&&t.length?[].slice.call(t):[t]:(e.__create_dom_div__||(e.__create_dom_div__=i.createElement("div")),e.__create_dom_div__.innerHTML=t,[].slice.call(e.__create_dom_div__.childNodes))};var t='<div class="shopex-poppicker">		<div class="shopex-poppicker-header">			<button class="shopex-btn shopex-poppicker-btn-cancel">取消</button>			<button class="shopex-btn shopex-btn-blue shopex-poppicker-btn-ok">确定</button>			<div class="shopex-poppicker-clear"></div>		</div>		<div class="shopex-poppicker-body">		</div>	</div>',s='<div class="shopex-picker">		<div class="shopex-picker-inner">			<div class="shopex-pciker-rule shopex-pciker-rule-ft"></div>			<ul class="shopex-pciker-list">			</ul>			<div class="shopex-pciker-rule shopex-pciker-rule-bg"></div>		</div>	</div>';e.PopPicker=e.Class.extend({init:function(s){var c=this;c.options=s||{},c.options.buttons=c.options.buttons||["取消","确定"],c.panel=e.dom(t)[0],i.body.appendChild(c.panel),c.ok=c.panel.querySelector(".shopex-poppicker-btn-ok"),c.cancel=c.panel.querySelector(".shopex-poppicker-btn-cancel"),c.body=c.panel.querySelector(".shopex-poppicker-body"),c.mask=e.createMask(),c.cancel.innerText=c.options.buttons[0],c.ok.innerText=c.options.buttons[1],c.cancel.addEventListener("tap",function(e){c.hide()},!1),c.ok.addEventListener("tap",function(e){if(c.callback){var i=c.callback(c.getSelectedItems());i!==!1&&c.hide()}},!1),c.mask[0].addEventListener("tap",function(){c.hide()},!1),c._createPicker(),c.panel.addEventListener(e.EVENT_START,function(e){e.preventDefault()},!1),c.panel.addEventListener(e.EVENT_MOVE,function(e){e.preventDefault()},!1)},_createPicker:function(){var i=this,t=i.options.layer||1,c=100/t+"%";i.pickers=[];for(var a=1;t>=a;a++){var n=e.dom(s)[0];n.style.width=c,i.body.appendChild(n);var o=e(n).picker();i.pickers.push(o),n.addEventListener("change",function(e){var i=this.nextSibling;if(i&&i.picker){var t=e.detail||{},s=t.item||{};i.picker.setItems(s.children)}},!1)}},setData:function(e){var i=this;e=e||[],i.pickers[0].setItems(e)},getSelectedItems:function(){var e=this,i=[];for(var t in e.pickers){var s=e.pickers[t];i.push(s.getSelectedItem()||{})}return i},show:function(t){var s=this;s.callback=t,s.mask.show(),i.body.classList.add(e.className("poppicker-active-for-page")),s.panel.classList.add(e.className("active")),s.__back=e.back,e.back=function(){s.hide()}},hide:function(){var t=this;t.disposed||(t.panel.classList.remove(e.className("active")),t.mask.close(),i.body.classList.remove(e.className("poppicker-active-for-page")),e.back=t.__back)},dispose:function(){var e=this;e.hide(),setTimeout(function(){e.panel.parentNode.removeChild(e.panel);for(var i in e)e[i]=null,delete e[i];e.disposed=!0},300)}})}(shopex,document);